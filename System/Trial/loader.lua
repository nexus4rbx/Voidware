...
local successful, response = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/Erchobg/Voidware/main/System/Trial/Modules/"..gamesupported..".lua", true) end)

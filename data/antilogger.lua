...
local whitelistedlinks = {"github.com/", "pastebin.com/", "voidwareclient.xyz/", "luarmor.net/", "controlc.com/", "raw.githubusercontent.com/", "roblox.com", "api.github.com/"} -- add urls to ignore here. should look like this {"url1", "url2"}
